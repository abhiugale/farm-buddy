                                    ...
                                    <div class="limit-box">
                                        <nav class="main-menu">
                                            <ul class="menu-area-main">
                                                ...
                                                <li> <a href="agriculture.php" style="--hover-color: green">Agriculture </a> </li>
                                                <li><a href="animal.php">Animal Husbandary</a></li>
                                                <li><a href="weather.php">Weather</a></li>
                                                <li><a href="Product.php">Product</a></li>
                                                <li><a href="signin-up.php"><button class="btn btn-outline-success text-white" style="">Login/Signup</button></a></li>
